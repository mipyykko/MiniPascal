...
namespace Parse
{
    ...
    {
        private static dynamic Pass(dynamic[] p) => p.GetType().IsArray ? p.Length == 1 ? p[0] : p : new[] {p};
        private static dynamic[] Flatten(dynamic[] p) => p.Flatten().ToArray();
        private static List<dynamic> ToList(dynamic[] p) => p.ToList();
        
        public static Rule[] Rules = {
            Rule.Of(StatementType.ProgramStatement, 
                Production.Of(KeywordType.Program, StatementType.Identifier, TokenType.Separator, StatementType.DeclarationBlock, StatementType.Block, TokenType.Dot), 
                Collect.Of(false, true, false, true, true, false), Program),
            ...
            Rule.Of(StatementType.VariableIds, 
                Production.Of(StatementType.Identifier, StatementType.Ids), Collect.Of(true, true), 
                Ids),
            Rule.Of(StatementType.Ids, Production.EpsilonProduction, Collect.NoCollect, null),
            Rule.Of(StatementType.Ids, 
                ...
                Flatten),
            Rule.Of(StatementType.Parameters, Production.EpsilonProduction, Collect.NoCollect, null),
            Rule.Of(StatementType.Parameters, 
                ...
                Collect.Of(true, true, false, true, true), 
                Parameters),
            Rule.Of(StatementType.Parameters, 
                Production.Of(StatementType.Identifier, TokenType.Colon, StatementType.Type, StatementType.OptParameters), 
                Collect.Of(true, false, true, true), 
                Parameters),
            Rule.Of(StatementType.OptParameters, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.Block, 
                ...
                Collect.Of(false, true, true), BlockStatement),
            ...
            Rule.Of(StatementType.AssignmentStatementOrCall, 
                ...
                CallStatement),
            Rule.Of(StatementType.Arguments, Production.EpsilonProduction, Collect.NoCollect, null),
            Rule.Of(StatementType.Arguments, 
                Production.Of(StatementType.Expr, StatementType.Exprs), 
                Collect.Of(true, true), 
                Arguments),
            Rule.Of(StatementType.Exprs, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.ReturnStatement, 
                ...
                Collect.Of(false, true), null),
            Rule.Of(StatementType.OptReturnExpr, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.ReadStatement, 
                ...
                Collect.Of(false, false, true, true, false), null),
            Rule.Of(StatementType.Variables, Production.EpsilonProduction, Collect.NoCollect, null),                 
            ...
            Rule.Of(StatementType.IfStatement, 
                ...
                IfStatement),
            Rule.Of(StatementType.ElseBranch, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.WhileStatement, 
                ...
                Collect.Of(false, true, false, true), null),
            Rule.Of(StatementType.Expr, 
                Production.Of(StatementType.SimpleExpr, StatementType.ExprCont), 
                Collect.Of(true, true), 
                Expr),
            Rule.Of(StatementType.ExprCont, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.SimpleExpr, 
                ...
                Collect.Of(true, true), 
                SimpleExprOrTerm),
            Rule.Of(StatementType.SimpleExprCont, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.Term, 
                ...
                Collect.Of(true, true), 
                SimpleExprOrTerm),
            Rule.Of(StatementType.TermCont, Production.EpsilonProduction, Collect.NoCollect, null),
            ...
            Rule.Of(StatementType.Factor, 
                ...
                Collect.Of(true, true), 
                Unary),
            Rule.Of(StatementType.FactorSize, Production.EpsilonProduction, Collect.NoCollect, null),
