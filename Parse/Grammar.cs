...
namespace Parse
{
    ...
    {
        private static dynamic[] Pass(dynamic[] p) => p;
        ...
        public static Rule[] Rules = {
            Rule.Of(StatementType.ProgramStatement, 
                ...
                Parameters.Of(false, true, false, true, false), Gatherer.Of(Program)),
            Rule.Of(StatementType.Declaration, 
                ...
                Parameters.Of(false, true, false, true), Gatherer.Of(VarDeclaration)),
            Rule.Of(StatementType.Declaration, 
            ...
            Rule.Of(StatementType.Block, 
                ...
                Parameters.Of(false, true, true), Gatherer.Of(BlockStatement)),
            ...
            Rule.Of(StatementType.AssignOrCallStatement,
                Production.Of(StatementType.CallOrVariable, StatementType.AssignmentStatementOrCall), 
                Parameters.Of(true, true), 
                Gatherer.Of(AssignOrCallStatement)),
            Rule.Of(StatementType.AssignmentStatementOrCall, 
                Production.Of(TokenType.Assignment, StatementType.Expr), 
                Parameters.Of(false, true), Gatherer.Of(AssignmentStatement)),
            Rule.Of(StatementType.AssignmentStatementOrCall, 
                Production.EpsilonProduction, 
                Parameters.NoParameters, Gatherer.Of(CallStatement)),
