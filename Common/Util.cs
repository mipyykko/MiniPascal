...
namespace Common
{
    ...
    {
        public static TU TryGetValueOrDefault<T, TU>(this Dictionary<T, TU> dictionary, T key,
            TU defaultValue = default)
        {
        ...
        public static void Deconstruct<T0, T1, T2, T3, T4>(this object[] items, out T0 t0, out T1 t1, out T2 t2,
            out T3 t3, out T4 t4)
        {
            t0 = items.Length > 0 ? (T0) items[0] : default;
            t1 = items.Length > 1 ? (T1) items[1] : default;
        ...
        public static void Deconstruct<T0, T1, T2, T3, T4, T5>(this object[] items, out T0 t0, out T1 t1, out T2 t2,
            out T3 t3, out T4 t4, out T5 t5)
        {
            t0 = items.Length > 0 ? (T0) items[0] : default;
            t1 = items.Length > 1 ? (T1) items[1] : default;
            t2 = items.Length > 2 ? (T2) items[2] : default;
        ...
        public static void Deconstruct<T0, T1, T2, T3, T4, T5, T6>(this object[] items, out T0 t0, out T1 t1, out T2 t2,
            out T3 t3, out T4 t4, out T5 t5, out T6 t6)
        {
            t0 = items.Length > 0 ? (T0) items[0] : default;
            t1 = items.Length > 1 ? (T1) items[1] : default;
            t2 = items.Length > 2 ? (T2) items[2] : default;
        ...
        public static void Deconstruct<T0, T1, T2, T3, T4, T5, T6, T7>(this object[] items, out T0 t0, out T1 t1,
            out T2 t2, out T3 t3, out T4 t4, out T5 t5, out T6 t6, out T7 t7)
        {
            t0 = items.Length > 0 ? (T0) items[0] : default;
            t1 = items.Length > 1 ? (T1) items[1] : default;
            t2 = items.Length > 2 ? (T2) items[2] : default;
        ...
        public static void Deconstruct<T0, T1, T2, T3, T4, T5, T6, T7, T8>(this object[] items, out T0 t0, out T1 t1,
            out T2 t2, out T3 t3, out T4 t4, out T5 t5, out T6 t6, out T7 t7, out T8 t8)
        {
            t0 = items.Length > 0 ? (T0) items[0] : default;
            t1 = items.Length > 1 ? (T1) items[1] : default;
            t2 = items.Length > 2 ? (T2) items[2] : default;
        ...
        public static void Deconstruct<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(this object[] items, out T0 t0,
            out T1 t1, out T2 t2, out T3 t3, out T4 t4, out T5 t5, out T6 t6, out T7 t7, out T8 t8, out T9 t9)
        {
            t0 = items.Length > 0 ? (T0) items[0] : default;
            t1 = items.Length > 1 ? (T1) items[1] : default;
            t2 = items.Length > 2 ? (T2) items[2] : default;
